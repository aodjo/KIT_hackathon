...
export default function Dashboard() {
  ...
  return (
    <AppLayout selectedClassId={selectedClass?.id} initialClassId={classIdFromUrl} onSelectClass={(cls) => { setSelectedClass(cls); if (!classIdFromUrl) navigate(`/c/${cls.id}`, { replace: true }); }} onClickClass={(cls) => { setSelectedClass(cls); navigate(`/c/${cls.id}`); }}>
